four51.app.config(['$routeProvider', '$locationProvider', function($routeProvider, $locationProvider) {
	...
	$routeProvider.
		...
		when('/videos', { templateUrl: 'partials/controls/videos.html'}).
		when('/menu', { templateUrl: 'partials/controls/menu.html' }).
		when('/projectRequest', {templateUrl: 'partials/controls/projectRequest.html', controllers: 'ProjectRequestCtrl' }).
		...
		when('/equipment', { templateUrl: 'partials/equipment.html' }).
